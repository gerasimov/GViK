...
GViK(function(gvik, require, Add) {
  ...
  var isBackground = !!chrome.extension.getViews;
  ...
  if (SUPPORT.downloads) {
    ...
    methods.downloadFromCache = function(o, p, c) {
      ...
      var i = 0;
      var ready = false;
      var urlmng = (window.URL || window.webkitURL);
      var url = o.url;
      var fromCache = false;
  ...
  methods.getHead = function (o, p, c, e) {
    core.getHead(o.url, o.hName, c, e);
  }
  ...
  if (isBackground) {
    ...
    chrome.commands.onCommand.addListener(function(command) {
      sendMessageToTab(commandsResponse.tabId, 'globalKey',
        [command, commandsResponse]);
    });
